...
const Navigation: FC = () => {
    return (
        <nav className={styles.navigation}>
            ...
            <NavLink className={styles.navigationItem} to={'/login'}>Login</NavLink>
            <NavLink className={styles.navigationItem} to={'/dashboard'}>
                <svg fill="#6583E2" width="36px" height="36px" viewBox="0 0 36 36" version="1.1"
